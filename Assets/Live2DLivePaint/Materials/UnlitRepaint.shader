...
Shader "Live2D Cubism/UnlitRepaint"
{
	Properties
	{
		// Texture and model opacity settings.
		[PerRendererData] _MainTex("Main Texture", 2D) = "white" {}
		[PerRendererData] _Retatch("Retatch Texture", 2D) = "white" {}
		[PerRendererData] _OverLine("Over Line Texture", 2D) = "white" {}
		[PerRendererData] cubism_ModelOpacity("Model Opacity", Float) = 1
		[PerRendererData] isPremultiedAlphaOut("is Premulti Out", Int) = 1
